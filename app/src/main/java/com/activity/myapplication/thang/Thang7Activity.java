...
public class Thang7Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView2 = findViewById(R.id.list_view7) ;
        models2 = ListDetails7.getList() ;
        listAdapter2 = new com.activity.myapplication.adapter.ListAdapter2(Thang7Activity.this, models2);
